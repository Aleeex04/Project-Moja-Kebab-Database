...
def insert_BLOB(itemid, itemname, itemdescription, itemprice, FileName):
	...
	try:
		...
		conn = psycopg2.connect(database ="Kebab", user = "postgres",
                        password = "alex2004", host = "localhost", port = "5432")
		...
		cur.execute(
            "INSERT INTO menuitems(itemid, itemname, itemdescription, itemprice, image) VALUES(%s,%s,%s,%s,%s)",(itemid, itemname, itemdescription, itemprice, BLOB))
